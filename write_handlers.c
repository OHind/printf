...
/**
 * handle_char - function that prints a string
 * @c: char types.
...
/**
 * write_numbers - function that prints a string
 ...
 * @ind: the index at which the number will starts on the buffer
 * @buffer: the buffer
 * @flags: the flags
 * @width: width
 ...
 * @is_negative: the number indicating if negative
 ...
 * @ind: the ndex where the number starts in the buffer
 * @length: the length of number
 * @width: width
 * @flags: flags
 * @padd: the char to represent the padding
 * @extra_c: the char to represent the extra char
